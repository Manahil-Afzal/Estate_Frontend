...
//         setApiListings([]); // fallback to empty, Dubai listings will still show
//       }
//     };
//     fetchListings();
//   }, []);
...
//           Find your next <span className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 drop-shadow-lg">perfect</span><br/>place with ease
//         </h1>
//         <p className="text-lg lg:text-xl text-gray-500">
//           Sahand Estate is the best place to find your next perfect place to live.<br/>
//           We have a wide range of properties for you to choose from.
//         </p>
//         <button onClick={() => navigate('/search')} className="mt-7 px-3 py-2 bg-blue-500 text-white font-semibold rounded hover:bg-blue-400 w-40">
//           Let's get started...
//         </button>
//       </div>
...
//       {/* Image Carousel */}
//       <div>
//         <Swiper modules={[Navigation, Pagination, Autoplay]} navigation pagination={{clickable:true}} autoplay={{delay:2500, disableOnInteraction:false}} spaceBetween={10} slidesPerView={2} breakpoints={{640:{slidesPerView:2},768:{slidesPerView:3},1024:{slidesPerView:4}}}>
//           {images.map((img,index) => (
//             <SwiperSlide key={index}>
//               <img src={img} alt={`Slide ${index+1}`} className="w-full h-80 object-cover rounded-lg shadow-lg"/>
//             </SwiperSlide>
//           ))}
//         </Swiper>
//       </div>
...
//             <Link to="/search?offer=true" className="text-blue-600 hover:underline text-sm">Show more offers</Link>
//           </div>
//           <div className="flex flex-wrap gap-6">
//             {offers.map(listing => (
//               <div key={listing._id || listing.id} onClick={() => handleCardClick(listing._id || listing.id)} className="cursor-pointer w-full sm:w-80">
...
//             <Link to="/search?type=rent" className="text-blue-600 hover:underline text-sm">Show more places for rent</Link>
//           </div>
//           <div className="flex flex-wrap gap-6">
//             {rentals.map(listing => (
//               <div key={listing._id || listing.id} onClick={() => handleCardClick(listing._id || listing.id)} className="cursor-pointer w-full sm:w-80">
...
//             <Link to="/search?type=sale" className="text-blue-600 hover:underline text-sm">Show more places for sale</Link>
//           </div>
//           <div className="flex flex-wrap gap-6">
//             {sales.map(listing => (
//               <div key={listing._id || listing.id} onClick={() => handleCardClick(listing._id || listing.id)} className="cursor-pointer w-full sm:w-80">
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4 text-left">
        <h1 className="text-6xl lg:text-7xl font-bold text-slate-700 leading-snug">
          Find your next{" "}
          <span className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 drop-shadow-lg">
            perfect
          </span>
          <br />
          place with ease
